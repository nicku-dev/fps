...
router = APIRouter(tags=["demo","ecataloc"])

@router.get("/ecataloc")
async def hello_word():
    """Hello World! - Ecataloc"""
    return {"Hello": "World Ecataloc"}

# demo_api_router = APIRouter()

class PartnerInfo(Partner):
    name: str
    email: str

@router.get("/ecataloc/partners", response_model=list[PartnerInfo])
